...
- 2026-09-23 — minimum macOS is 27+ (lead's decision, overriding pm's 26+: the human's Mac runs 27, troupe is
  single-user, and it's reversible; closes that open question). `troupe start` and
